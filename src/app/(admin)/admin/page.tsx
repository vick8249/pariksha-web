...
import { Users, BookOpen, Trophy, TrendingUp, Clock, ArrowRight, Plus } from 'lucide-react'
    ...
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
        {[
          ...
          <Link key={label} href={href} className="bg-white rounded-2xl border border-gray-200 p-5 hover:shadow-md transition-shadow">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 mb-8">
        <div className="lg:col-span-2 bg-white rounded-2xl border border-gray-200 p-5">
          <div className="flex items-center justify-between mb-4">
            <h2 className="font-bold text-gray-900">Recent Exam Attempts</h2>
            <Link href="/admin/reports" className="text-xs text-indigo-600 hover:underline flex items-center gap-1">
              ...
              {stats.recentAttempts.map((attempt) => (
                <div key={attempt.id} className="py-3 flex items-center justify-between gap-3">
                  <div className="min-w-0">
                    <p className="text-sm font-medium text-gray-900 truncate">{attempt.user.name}</p>
