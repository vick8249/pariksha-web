...
export default function DeleteStudentButton({ userId, studentName }: { userId: string, studentName: string }) {
  ...
  return (
    <button
      ...
      disabled={isPending}
      className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold bg-red-50 text-red-700 border border-red-200 rounded-lg hover:bg-red-100 hover:text-red-800 hover:border-red-300 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
